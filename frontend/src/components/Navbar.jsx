...
const isNotActiveStyle = 'flex rounded-2xl flex-none  bg-gray-100 items-center px-3 gap-3 text-gray-700 mx-3 hover:text-black transition-all duration-200 ease-in-out capitalize';
const isActiveStyle = 'flex text-white  rounded-2xl shadow-md  flex-none items-center bg-gray-700 px-3 mx-3 gap-3   border-black  transition-all duration-200 ease-in-out capitalize';

function Navbar({searchTerm, setSearchTerm, user, exploreBool, setExploreBool}) {
      ...
      exploreBool && (    <div>
        <div className='flex gap-2 md:gap-5 mt-5 pb-7 '>
          <div className='flex justify-start items-center w-full px-2 rounded-md bg-white border-none outline-none focus-within:shadow-sm'>
            ...
            />
            <h3 className='text-purple-700 font-bold'>{"456+"}</h3>
        ...
        <div className='flex overflow-x-scroll hide-scrollbar flex-wrap' ref={catagoriesRef}>
