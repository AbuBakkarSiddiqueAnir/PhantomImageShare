    ...
    <div className='flex flex-col justify-content items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex lg:flex-row flex-col justify-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
        <div className='bg-secondaryColor p-3 flex flex-0.7 w-full'>
          <div className='flex justify-center items-center flex-col border-2 border-dotted p-3 w-full h-420 border-gray-300'>
        {
          loading && (
            <Spinner/>
          )
      ...
      {user && (
            <div className="flex gap-2 mt-2 mb-2 items-center bg-white rounded-lg ">
              {/* <img
                ...
                alt="user-profile"
              /> */}
              <p className="font-bold">Hey {user.userName.toLowerCase()} notes your pin's detail :</p>
            </div>
          )}
          <input
            type="text"
